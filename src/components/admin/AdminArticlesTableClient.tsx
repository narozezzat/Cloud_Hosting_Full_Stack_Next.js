...
import { DeleteOutlined, EditOutlined, MoreOutlined, ReadOutlined } from "@ant-design/icons";
...
const AdminArticlesTableClient = ({ articles, pages, currentPage }: AdminArticlesTableClientProps) => {
