    ...
    <div className="fixed top-0 left-0 bottom-0 right-0 z-10 bg-black bg-opacity-40 flex items-center justify-center">
      <div className="w-11/12 lg:w-2/4 bg-white rounded-lg p-3">
        ...
        <div className="flex justify-between gap-3">
          <button
            onClick={onClose}
            className="bg-gray-500 w-1/2 text-white p-1 text-xl rounded-lg hover:bg-gray-600 transition"
          >
            Cancel
          </button>
          <button
            onClick={onDelete}
            className="bg-red-600 w-1/2 text-white p-1 text-xl rounded-lg hover:bg-red-700 transition"
          >
            Delete
          </button>
        </div>
