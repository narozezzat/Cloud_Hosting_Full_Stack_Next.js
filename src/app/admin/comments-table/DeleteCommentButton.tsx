...
const DeleteCommentButton = ({ commentId, commentText }: DeleteCommentButtonProps) => {
    ...
    return (
        <>
            ...
            <ConfirmationModal
                ...
                message={<>Are you sure you want to delete this comment? <p className="font-bold">"{commentText}"</p></>}
                confirmText="Delete"
                cancelText="Cancel"
                isLoading={isLoading}
            />
